...
let DOMPurify: { sanitize: (html: string, config?: Record<string, unknown>) => string } | null = null;
...
try {
  ...
  if (typeof window !== "undefined") {
    ...
    require("dompurify");
    DOMPurify = (window as typeof window & { DOMPurify?: typeof DOMPurify }).DOMPurify || null;
  }
} catch {
