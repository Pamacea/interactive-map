...
import { MapSkeleton } from "@/features/world-editor/ui/map-skeleton";
import { FloatingParticles } from "@/shared/ui/particles";
import { useWorldInitializationWithWorldId } from "@/features/world-editor/logic/use-world-initialization";
import { useAutosavePreparation } from "@/features/world-editor/logic/use-autosave-preparation";
import { useAutosave } from "@/shared/hooks/use-autosave";
import { useKeyboardShortcut, SHORTCUTS } from "@/shared/hooks/use-keyboard-shortcut";
import { updateWorldState } from "@/features/worlds";
import { ErrorBoundary } from "@/shared/ui/error-boundary";
import { MapExportProvider } from "@/features/export/utils/use-map-export-context";
import { useLoreStore } from "@/features/lore/store";
import { useSelectPin, useSetPins } from "@/features/pins/store";
import { useSearchStore } from "@/features/search/store/use-search-store";
import { safeJsonStringify } from "@/shared/lib/sanitize";
// New layout components
import { TopBar } from "@/features/world-editor/ui/bars";
import { LeftDock, RightDock } from "@/features/world-editor/ui/docks";
...
import {
  ...
  ActivityModule,
  ImportModule,
} from "@/features/world-editor/ui/floating";
// Tool controls
import { MeasureControls } from "@/features/world-editor/ui/measure-controls";
import { BarsContainer, ShortcutsDialog } from "@/features/world-editor/ui/bars";
...
const MapCanvas = lazy(() =>
  import("@/features/world-editor/ui/map-canvas").then((mod) => ({
...
export const WorldClient = memo(function WorldClient({
  ...
  useEffect(() => {
    if (pins && pins.length > 0) {
      setPins(pins as unknown as import("@prisma/client").Pin[]);
    }
  }, [pins, setPins]);
        ...
        <div className="h-screen w-screen bg-void relative overflow-hidden">
          ...
          <ErrorBoundary
            onError={(error, errorInfo) => {
              ...
              (window as typeof window & { __lastError?: { message: string; stack?: string; componentStack?: string } }).__lastError = {
