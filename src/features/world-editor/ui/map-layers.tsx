...
export const MapLayers = memo(function MapLayers({
  ...
  const handleRegionClick = useCallback((regionWithLayer: RegionWithLayer) => {
    if (onRegionClick) {
      const { layerVisible: _layerVisible, layerOpacity: _layerOpacity, layerScale: _layerScale, layerOffsetX: _layerOffsetX, layerOffsetY: _layerOffsetY, ...region } = regionWithLayer;
