...
export const MeasureOverlay = memo(function MeasureOverlay({ _containerRef }: MeasureOverlayProps) {
  const points = useMeasurePoints();
  const segments = useMeasureSegments();
  const { pixels: _totalPixels, world: totalWorld } = useMeasureTotalDistance();
