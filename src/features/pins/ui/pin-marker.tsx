...
import { useSelectPin, useSelectedPinId, useClearSelection, usePinById } from "@/features/pins/store";
import { getPinTypeConfig } from "@/constants/pin-types";
import { usePinEvents } from "@/features/pins/logic/use-pin-events";
import { usePinScreenCoordinates } from "@/features/pins/logic/use-pin-screen-coordinates";
import { usePinDragInput } from "@/features/pins/logic/use-pin-drag-input";
...
export function PinMarker({
  ...
  // Icon configuration
  const pinConfig = getPinTypeConfig(pin.pinType) || { icon: "MapPin", color: "#3b82f6", label: "Pin" };
