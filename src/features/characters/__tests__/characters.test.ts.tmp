...
beforeEach(() => {
  ...
  (verifyWorldPermission as any).mockResolvedValue(mockWorld);
  (verifyCharacterPermission as any).mockResolvedValue(mockCharacter);
...
describe("Characters - Schema Validation", () => {
  ...
  describe("UpdateCharacterSchema", () => {
    it("should validate partial updates", () => {
      ...
      const result = UpdateCharacterSchema.safeParse(validData);
      expect(result.success).toBe(true);
    });
    ...
    it("should require character ID", () => {
      ...
      const result = UpdateCharacterSchema.safeParse(invalidData);
      expect(result.success).toBe(false);
    });
...
describe("Characters - Relations", () => {
  it("should fetch character with user and world relations", async () => {
    ...
    const result = await getCharacterById("char-1");
  ...
  it("should return null for non-existent character", async () => {
    ...
    const result = await getCharacterById("non-existent");
...
describe("Characters - Filtering", () => {
  it("should filter by character types", async () => {
    ...
    const result = await getCharactersFiltered({
      gameWorldId: "world-1",
...
describe("Characters - Batch Operations", () => {
  ...
  it("should verify all characters belong to same world during reorder", async () => {
    ...
    const result = await reorderCharacters("world-1", updates);
  ...
  it("should verify world permission before reorder", async () => {
    ...
    (verifyWorldPermission as any).mockRejectedValue(new Error("No permission"));
...
describe("Characters - Visibility", () => {
  it("should toggle character visibility", async () => {
    ...
    const result = await toggleCharacterVisibility("char-1");
  ...
  it("should verify permission before toggling visibility", async () => {
    (verifyCharacterPermission as any).mockRejectedValue(new Error("No permission"));
...
describe("Characters - Error Handling", () => {
  it("should handle authentication errors", async () => {
    (getAuthenticatedUser as any).mockRejectedValue(new Error("Not authenticated"));
