...
const STAT_CONFIG: Array<{
  ...
  { key: "strength", _label: "STR", icon: <Sword className="w-3 h-3" />, color: "text-red-400" },
  { key: "dexterity", _label: "DEX", icon: <Zap className="w-3 h-3" />, color: "text-green-400" },
  { key: "constitution", _label: "CON", icon: <Heart className="w-3 h-3" />, color: "text-orange-400" },
  { key: "intelligence", _label: "INT", icon: <Brain className="w-3 h-3" />, color: "text-blue-400" },
  { key: "wisdom", _label: "WIS", icon: <Eye className="w-3 h-3" />, color: "text-purple-400" },
  { key: "charisma", _label: "CHA", icon: <Users className="w-3 h-3" />, color: "text-pink-400" },
];
