...
// Unused relation types kept for documentation
// import type { CharacterRelationship, CharacterPinRelation, Pin } from "@prisma/client";
import { useQueryClient } from "@tanstack/react-query";
import { useCharacterStore } from "@/features/characters/store/use-character-store";
import { useCharacter, characterKeys } from "@/features/characters/logic/use-characters-query";
...
// Unused types kept for documentation
// type _CharacterWithRelations = Character & {
...
export function CharacterDetail({ characterId, worldId, characters, onClose }: CharacterDetailProps) {
  ...
  // TanStack Query for fetching character with relations
  const { data: fullCharacter, isLoading: isLoadingCharacter } = useCharacter(characterId);
