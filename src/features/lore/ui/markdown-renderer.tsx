      ...
      <ReactMarkdown
        ...
        components={{
          ...
          a: ({ node: _node, href, ...props }) => {
            ...
            const nodeData = _node as { tagName?: string; properties?: { dataSlug?: string } } | undefined;
            const isWikiLink = nodeData?.tagName === "WIKI-LINK";

            if (isWikiLink) {
              const slug = nodeData?.properties?.dataSlug;
              return (
                <span
