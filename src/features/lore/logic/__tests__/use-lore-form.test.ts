...
let mockStore: {
  ...
  loreEntries: unknown[];
  filteredLoreEntries: unknown[];
  isLoading: boolean;
  error: null;
  createLoreEntry: ReturnType<typeof vi.fn>;
  updateLoreEntryServer: ReturnType<typeof vi.fn>;
  selectLore: ReturnType<typeof vi.fn>;
  clearSelection: ReturnType<typeof vi.fn>;
  toggleExpanded: ReturnType<typeof vi.fn>;
  startCreating: ReturnType<typeof vi.fn>;
  stopCreating: ReturnType<typeof vi.fn>;
  startEditing: ReturnType<typeof vi.fn>;
  stopEditing: ReturnType<typeof vi.fn>;
  setLoreEntries: ReturnType<typeof vi.fn>;
  addLoreEntry: ReturnType<typeof vi.fn>;
  updateLoreEntry: ReturnType<typeof vi.fn>;
  deleteLoreEntry: ReturnType<typeof vi.fn>;
  deleteLoreEntryServer: ReturnType<typeof vi.fn>;
  setSearchTerm: ReturnType<typeof vi.fn>;
  setCategoryFilter: ReturnType<typeof vi.fn>;
  toggleCategoryFilter: ReturnType<typeof vi.fn>;
  showAllCategories: ReturnType<typeof vi.fn>;
  hideAllCategories: ReturnType<typeof vi.fn>;
  toggleShowVisibleOnly: ReturnType<typeof vi.fn>;
  resetFilters: ReturnType<typeof vi.fn>;
  applyFilters: ReturnType<typeof vi.fn>;
  getVisibleCategories: ReturnType<typeof vi.fn>;
...
describe("useLoreForm", () => {
  ...
  describe("resetForm", () => {
    ...
    it("should clear errors on reset", async () => {
      ...
      const _hasErrorsBefore = Object.keys(result.current.errors).length > 0;
