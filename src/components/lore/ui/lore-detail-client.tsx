  ...
  const processedContent = React.useMemo(() => {
    ...
    return (lore.content || "").replace(
      ...
      (match, entryTitle) => {
        ...
        if (linkedEntry) {
          const safeId = escapeHtml(linkedEntry.id);
          const safeSlug = escapeHtml(linkedEntry.slug);
          const safeTitle = escapeHtml(linkedEntry.title);
          const safeLinkText = escapeHtml(entryTitle);
                ...
                {lore.linkedPins.map((pin) => (
                  <Link
                    ...
                    onClick={() => {
                      ...
                      console.log("Navigate to pin:", pin.id);
                    }}
