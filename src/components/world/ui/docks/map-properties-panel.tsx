...
import { PropertyColorPicker, PRESET_COLORS } from "@/components/ui/properties/property-color-picker";
import { useBackgroundColor, useMapStore } from "@/stores/map-store";
